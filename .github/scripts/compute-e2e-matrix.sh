...
OC_ALL='[
  ...
  {"name":"langgraph-opentelemetry","app_dir":"langgraph/opentelemetry/openai","test_file":"test/e2e/langgraph_opentelemetry_test.go","test_run":"TestLangGraphOpenTelemetry","otel_service_name":"langgraph"},
  {"name":"langgraph-opentelemetry-bedrock","app_dir":"langgraph/opentelemetry/bedrock","test_file":"test/e2e/langgraph_opentelemetry_test.go","test_run":"TestLangGraphOpenTelemetryBedrock","otel_service_name":"langgraph-bedrock"},
