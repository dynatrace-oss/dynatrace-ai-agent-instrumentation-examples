...
OC_ALL='[
  ...
  {"name":"n8n-opentelemetry","app_dir":"n8n/opentelemetry","test_file":"test/e2e/n8n_opentelemetry_test.go","test_run":"TestN8NOpenTelemetryOpenAI","otel_service_name":"n8n","model":"gpt-4o-mini"}
]'
