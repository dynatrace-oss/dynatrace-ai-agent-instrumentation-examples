...
OC_ALL='[
  ...
  {"name":"openai-openinference-bindplane","app_dir":"openai/openinference/bindplane","test_file":"test/e2e/openai_openinference_bindplane_test.go","test_run":"TestOpenAIOpenInferenceBindplane","otel_service_name":"openai/openinference/bindplane"},
  ...
  {"name":"langgraph-opentelemetry","app_dir":"langgraph/opentelemetry","test_file":"test/e2e/langgraph_opentelemetry_test.go","test_run":"TestLangGraphOpenTelemetry","otel_service_name":"langgraph"},
