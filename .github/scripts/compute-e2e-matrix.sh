...
OC_ALL='[
  ...
  {"name":"anthropic-openinference","app_dir":"anthropic/openinference","test_file":"test/e2e/anthropic_openinference_test.go","test_run":"TestAnthropicOpenInference","otel_service_name":"anthropic/openinference","model":"claude-haiku-4-5-20251001"},
