...
func TestGoogleADKOpenTelemetry(t *testing.T) {
	...
	// Metric results are recorded in the generated report alongside the span audit.
	auditSpanWithMetrics(t, "google-adk", "opentelemetry", GenericProfile,
		`fetch spans, from: now()-10m
| filter service.name == "google-adk-samples"
| filter gen_ai.system == "gemini"
| sort timestamp desc
| limit 1`,
		"google-adk-samples", genAIClientMetrics)
}
